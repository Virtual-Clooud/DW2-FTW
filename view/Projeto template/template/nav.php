...
border-body navbar-expand-lg bg-body-tertiary"
data-bs-theme="dark">
<div class="container-fluid">
    ...
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
        <a class="nav-link" href="index.php?p=cidades">Cidades</a>
        </li>

        <li class="nav-item">
        <a class="nav-link" href="index.php?p=categorias">Categorias</a>
        </li>
        ...
        <li class="nav-item">
        <a class="nav-link" href="index.php?p=usuarios">Usuários</a>
        </li>
